...
public class Movie : IMovie
{
    ...
    public bool AddBorrower(IMember member)
    {
        if (AvailableCopies >= 1)
        {
            ...
            {
                Console.WriteLine("Can not borrow more than one copy of a movie at a time");
                return false;
            }
    ...
    public int CompareTo(IMovie another)
    {
        ...
        else if (movie.title.CompareTo(this.title) == 0)
        {
            return 0;
        }
        else
    ...
    public string ToString()
    {
        ...
        return "Title: " +  title.ToString() + ", Genre: "+ genre.ToString() + ", " +" Classification: " + classification.ToString() + ", Duration: "+ duration.ToString() + " min, Available copies: " + AvailableCopies.ToString();
    }
